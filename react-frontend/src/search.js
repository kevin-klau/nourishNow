...
export default function UserSearch({state}){
    ...
    async function callgpt(input){
        ...
        let response2 = response1.replace("Ingredients:","<h2 id='IngredientsTitle'><strong>Ingredients:</strong></h2><h4 id='Ingredients'>");
        let response3 = response2.replace("Instructions:","</h4><h2 id='IntructionsTitle'><strong>Instructions:</strong></h2><h4 id='Instructions'>")
        let response4 = response3.replace("Directions:","</h4><h2 id='DirectionsTitle'><strong>Directions:</strong></h2><h4 id='Directions'>")
        
        let response5 = response4.replace("HIHI","</h4>")
    ...
    return(
        <div id="searchContainer">
            ...
            <p id="k" style={{ overflowWrap: "break-word", maxWidth: "100%" }}></p>
